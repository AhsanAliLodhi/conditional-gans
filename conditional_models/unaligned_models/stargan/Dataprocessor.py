...
if __name__ == "__main__" :
    ...
    python Dataprocessor.py -c 100 -s my_source_folder/ -d output/ -t 0.2 -k subdir/

    My usage
    python Dataprocessor.py -c 1000 -s robocardata/ -d real/ -t 0.2 -r 256

    python Dataprocessor.py -c 10 -s robocardata/sunny/stereo/centre/  -r 256 -i True

    python Dataprocessor.py -c 1000 -s test/cgan/ -d augmented/ -t 0.2 -r 256  -k ""
